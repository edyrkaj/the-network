		...
		<div id="v_rightcol">
			<div id="memberhome">
				<h3>Hemma hos <?php echo $this->session->userdata('username') ?></h3>
					<div id="tabsK"><ul class="menupage"><li class="menupagelink"><a href=""><span>presentation</span></a></li><li class="menupagelink"><a href=""><span>CV</span></a></li><li class="menupagelink"><a href=""><span>portfolio</span></a></li></ul></div>
