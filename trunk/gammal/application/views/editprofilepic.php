...
$upload_dir = $username; 				// The directory for the images to be saved in
...
<?php echo $result;  ?>
	...
	<?php if(file_exists($_SERVER['DOCUMENT_ROOT'] . "/network/images/userimages/$username/profileimg/thumbnail_.jpg")) { ?>
			...
			<img class="rounded" src="/../network/images/userimages/<?php echo $username ?>/profileimg/resize_.jpg" />
