...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
			...
			<h1 style="margin-left:25px"><input type="radio" name="form_select" checked="checked" id="private" />privatperson /
			<input type="radio" name="form_select" id="company" />företag</h1>
			...
			<div style="margin-left:-10px" id="rgstr_company">				
				<?php echo form_open('validation/register');?>
					<ul>
						...
						<li><?php echo form_error('companyname'); ?></li>
						...
						<li><?php echo form_error('regnumber'); ?></li>
						...
						<li><?php echo form_error('contactperson'); ?></li>
						
						<li><label for="username">Användarnamn </label></li>
						<li><input class="rounded" type="text" name="username" value="<?php echo set_value('username'); ?>" /></li>
						<li><?php echo form_error('username'); ?></li>
						
						<li><label for="username">E-post</label></li>
						<li><input class="rounded" type="text" name="email" value="<?php echo set_value('email'); ?>" /></li>
						<li><?php echo form_error('email'); ?></li>
						
						<li><label for="password">Lösenord</label></li>
						<input class="rounded" type="password" name="password" value="<?php echo set_value('password'); ?>" /></li>
						<li><?php echo form_error('password'); ?></li>

							
						<li><label for="confirm_password">Bekräfta lösenord</label></li>
						<input class="rounded" type="password" name="comfirm_password" value="<?php echo set_value('confirm_password'); ?>" />
