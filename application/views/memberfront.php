		...
		<div id="v_rightcol">
			<div id="memberhome">
				<h3>Hemma hos <?php echo $this->session->userdata('username') ?></h3>
					...
					<a href="<?php echo base_url();?>gallery/showportfolio"><span>portfolio</span></a></li></ul></div>
			...
			<div id="profilefact">
				<ul>
					...
					<li><span id="facts">Ålder: </span><span style="font-size: 10pt; font-family: helvetica"><?php echo $age ?><?php if ($age > 0) {echo 'år';} ?></span></li>
